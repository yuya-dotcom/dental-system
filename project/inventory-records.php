...
// ── Fix 1: Local badge helper — overrides any controller version ──
// Covers all possible status values including in_stock.
if (!function_exists('invStatusBadge')) {
    function invStatusBadge(?string $status): string {
        return match (strtolower($status ?? '')) {
            'in_stock'     => 'bg-soft-success text-success',
...
if (!function_exists('invStatusLabel')) {
